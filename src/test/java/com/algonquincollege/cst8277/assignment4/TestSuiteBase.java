...
public class TestSuiteBase {
    ...
    static EntityManagerFactory buildEntityManagerFactory() {
        ...
        /*
         * prevent bug 521424 - if one restarts a PU without stopping the JVM (say in a
         * series of JUnit tests), the singleton Session log has stuff from the last
         * 'live' session. Solution: reset log and then re-create EMF, custom SLF4J
    ...
    public static void detachListAppender(ch.qos.logback.classic.Logger theLogger,
